...
fatigue_request = DriversFatigue(
    timestamp="2020-07-14T16:46:00Z",
    drivers=[
        DriverFatigue(hash_id="a",
                      online=50,
                      on_order=100),
        DriverFatigue(hash_id="b",
                      online=100,
                      on_order=50),
    ]
)
...
online_hourly_request = OnlineHourly(
    timestamp="2020-07-14T16:46:00Z",
    drivers=[
        DriverData(
...
online_quarter_hourly_request = OnlineQuarterHourly(
    timestamp="2020-07-14T16:46:00Z",
    drivers=[
        DriverData(
